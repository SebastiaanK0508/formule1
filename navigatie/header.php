...
$predictUrl = 'https://predict.f1site.nl';
?>
<style>
    #mobile-menu {
        position: fixed;
...
<div id="mobile-menu">
    ...
    <nav class="flex flex-col space-y-2">
        ...
        <?php endforeach; ?>
        <a href="<?php echo $predictUrl; ?>" target="_blank" rel="noopener" class="mobile-link group py-4 border-b border-white/5 text-white/60 hover:text-white transition-all">
            <div class="flex items-center justify-between">
                <span class="text-2xl font-oswald font-black uppercase italic tracking-tighter transition-transform group-hover:translate-x-2">
                    Predict <span class="text-f1-red text-base align-top">↗</span>
                </span>
                <span class="text-f1-red font-mono text-[10px] opacity-40">0<?php echo $count++; ?></span>
            </div>
        </a>
...
<header class="sticky top-0 z-[100] bg-black/90 backdrop-blur-md border-b border-white/5">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav class="hidden xl:flex items-center gap-6 text-[11px] font-black uppercase tracking-[0.2em] text-white/70">
